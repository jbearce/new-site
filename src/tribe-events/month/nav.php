...
if ($prev_url) {
    echo "<a class='pagination__link link __left' href='{$prev_url}' rel='prev'><i class='fa fa-caret-left'></i> {$prev_text}</a>";
}
...
if ($next_url) {
    echo "<a class='pagination__link link __right' href='{$next_url}' rel='next'>{$next_text} <i class='fa fa-caret-right'></i></a>";
}
