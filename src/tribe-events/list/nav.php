...
if (tribe_has_previous_event()) {
    ...
    printf("<i class='fa fa-caret-left'></i> " . esc_html__("Previous %s", "new_site"), $events_label_plural);
    echo "</a>";
}
...
if (tribe_has_next_event()) {
    ...
    printf(esc_html__("Next %s", "new_site"), $events_label_plural .  "<i class='fa fa-caret-right'></i>");
    echo "</a>";
}
