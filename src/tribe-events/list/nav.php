...
if (tribe_has_previous_event()) {
    echo "<a class='pagination_link link _left' href='" . esc_url(tribe_get_listview_prev_link()) . "' rel='prev'>";
...
if (tribe_has_next_event()) {
    echo "<a class='pagination_link link _right' href='" . esc_url(tribe_get_listview_next_link()) . "' rel='next'>";
