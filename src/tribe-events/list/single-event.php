...
<article id="post-<?php the_ID(); ?>" class="<?php tribe_events_event_classes(); ?> tribe-events-list_article article -eventexcerpt" <?php if ($post->post_parent): ?> data-parent-post-id="<?php echo absint($post->post_parent); ?>"<?php endif; ?>>
