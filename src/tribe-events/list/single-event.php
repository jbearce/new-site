...
// display the excerpt
echo "<div class='article_content content'><p class='article_text text'><a class='article_link link' href='{$permalink}'>" . strip_tags(tribe_events_get_the_excerpt()) . "</a></p></div>";
