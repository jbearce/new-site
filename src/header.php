...
<html <?php language_attributes(); ?>>
	<head>
        ...
        <?php $enable_critical_css = $_GET["disable_critical_css"] !== "true" && $_COOKIE["previously_visited"] != true && file_exists(get_template_directory() . "/assets/styles/critical_" . preg_replace("/.php$/i", "", basename($template)) . ".css") ? true : false; ?>
