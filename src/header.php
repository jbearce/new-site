        ...
        <div class="page-container">
            ...
            <div class="banner-container" data-banner="old-browser" hidden>
                <div class="banner-block">
                    <h6 class="banner_title title"><i class="fa fa-internet-explorer"></i> <?php _e("Old<br /> Browser", "new-site"); ?></h6>
                    ...
                    <button class="banner_button button"><i class="fa fa-times-circle"></i> <span class="_visuallyhidden"><?php _e("Hide Notice", "new-site"); ?></span></button>
                </div>
            </div>
            <![endif]-->
            <?php if (WP_DEBUG): ?>
            <div class="banner-container -notice" data-banner="under-construction" hidden>
                <div class="banner-block">
                    <h6 class="banner_title title"><i class="fa fa-info-circle"></i> <?php _e("Under<br /> Construction", "new-site"); ?></h6>
                    <p class="banner_text text"><?php _e("Pardon our dust! If you're seeing this, it means we're working on an update to the site. You may experience some errors during this time. Please check back later if you're having trouble.", "new-site"); ?></p>
                    <button class="banner_button button"><i class="fa fa-times-circle"></i> <span class="_visuallyhidden"><?php _e("Hide Notice", "new-site"); ?></span></button>
                </div><!--/.banner-block-->
            ...
            <noscript>
                <div class="banner-container -notice" data-banner="noscript" hidden>
                    <div class="banner-block">
                        <h6 class="banner_title title"><i class="fa fa-info-circle"></i> <?php _e("Enable<br /> JavaScript", "new-site"); ?></h6>
                        <p class="banner_text text"><?php _e("Uh oh! It looks like you have JavaScript turned off. While most of our site should function with out, we recommend turning it back on for a better experience.", "new-site"); ?></p>
                        <button class="banner_button button"><i class="fa fa-times-circle"></i> <span class="_visuallyhidden"><?php _e("Hide Notice", "new-site"); ?></span></button>
                    </div><!--/.banner-->
                </div><!--/.banner-wrapper-->
            </noscript>
            <div class="header-container">
                <header class="header-block">
                    ...
                    <?php get_search_form(); ?>
                    <button class="header_menu-button menu-button _mobile"><?php _e("Menu", "new-site"); ?></button>
                </header><!--/.header-block-->
            ...
            <div class="nav-container _tablet _desktop">
                <div class="nav-block">
                    ...
                    wp_nav_menu(array(
                        "container"		 => false,
                        "depth"          => 3,
                        "items_wrap"	 => "<nav class='header_menu-container menu-container'><ul class='header_menu-list menu-list title'>%3\$s</ul></nav>",
                        "theme_location" => "primary",
