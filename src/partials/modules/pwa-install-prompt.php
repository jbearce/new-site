<div class="pwa-install-prompt__container">
    ...
    <div class="pwa-install-prompt">
        <img class="pwa-install-prompt__icon" src="<?php echo get_theme_file_uri("assets/media/logo-ios.png") ?>" alt="<?php bloginfo("name"); ?>" />
        ...
        <button class="pwa-install-prompt__close"><?php _e("Close", "__gulp_init_namespace__"); ?></button>
