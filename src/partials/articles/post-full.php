...
$article_meta      = isset($template_args["article_meta"]) ? $template_args["article_meta"] : ($post ? get_article_meta($post->ID) : "");
$article_content   = isset($template_args["article_content"]) ? $template_args["article_content"] : ($post ? apply_filters("the_content", $post->post_content) : "");
?>
