...
function __gulp_init__namespace_enqueue_scripts() {
    ...
    // modern styles
    wp_register_style("__gulp_init__namespace-styles-modern", get_theme_file_uri(__gulp_init__namespace_get_theme_file_path("assets/styles/", "modern.*.css")), array("__gulp_init__namespace-google-fonts"), "@@version");

    // legacy styles
    wp_register_style("__gulp_init__namespace-styles-legacy", get_theme_file_uri(__gulp_init__namespace_get_theme_file_path("assets/styles/", "legacy.*.css")), array("__gulp_init__namespace-styles-modern"), "@@version");

    // print styles
    wp_register_style("__gulp_init__namespace-styles-print", get_theme_file_uri(__gulp_init__namespace_get_theme_file_path("assets/styles/", "print.*.css")), array("__gulp_init__namespace-styles-modern"), "@@version", "print");

    // critical styles
    $critical_styles = __gulp_init__namespace_get_critical_css($template);
    if ($critical_styles) wp_add_inline_style("__gulp_init__namespace-styles-modern", $critical_styles);

    /* scripts */

    // modern scripts
    wp_register_script("__gulp_init__namespace-scripts-modern", get_theme_file_uri(__gulp_init__namespace_get_theme_file_path("assets/scripts/", "modern.*.js")), array(), "@@version", true);
