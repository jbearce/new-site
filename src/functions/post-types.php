...
function __gulp_init__namespace_create_resource_post_type() {
    $type_plural_name   = __("Resources", "__gulp_init__namespace");
    ...
    $taxonomy_plural_name   = __("Tags", "__gulp_init__namespace");
    $taxonomy_singular_name = __("Tag", "__gulp_init__namespace");
    ...
    register_taxonomy(
        ...
        array(
            ...
            "labels"         => array(
                ...
                "popular_items"              => sprintf(__("Popular %s", "__gulp_init__namespace"), $taxonomy_plural_name),
                "all_items"                  => sprintf(__("All %s", "__gulp_init__namespace"), $taxonomy_plural_name),
                "edit_item"                  => sprintf(__("Edit %s", "__gulp_init__namespace"), $taxonomy_singular_name),
                "update_item"                => sprintf(__("Update %s", "__gulp_init__namespace"), $taxonomy_singular_name),
                "add_new_item"               => sprintf(__("Add New %s", "__gulp_init__namespace"), $taxonomy_singular_name),
                "new_item_name"              => sprintf(__("New %s Name", "__gulp_init__namespace"), $taxonomy_singular_name),
                "separate_items_with_commas" => sprintf(__("Separate %s with commas", "__gulp_init__namespace"), strtolower($taxonomy_plural_name)),
                "add_or_remove_items"        => sprintf(__("Add or remove %s", "__gulp_init__namespace"), strtolower($taxonomy_plural_name)),
                "choose_from_most_used"      => sprintf(__("Choose from the most used %s", "__gulp_init__namespace"), strtolower($taxonomy_plural_name)),
...
add_action("init", "__gulp_init__namespace_create_resource_post_type");
