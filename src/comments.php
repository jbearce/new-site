...
<div id="respond">
    ...
    <form action="<? echo site_url(); ?>/wp-comments-post.php" method="post" id="commentform">
        ...
        <? else: ?>
        <p><input class="inpt inpttext" type="text" name="author" id="author" value="<? echo esc_attr($comment_author); ?>" size="22" tabindex="1" <? if ($req) echo "aria-required='true'"; ?> />
        <label for="author"><small><? _e('Name'); ?> <? if ($req) _e('(required)'); ?></small></label></p>
        <p><input class="inpt inpttext" type="text" name="email" id="email" value="<? echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" <? if ($req) echo "aria-required='true'"; ?> />
        <label for="email"><small><? _e('Mail (will not be published)'); ?> <? if ($req) _e('(required)'); ?></small></label></p>
        <p><input class="inpt inpttext" type="text" name="url" id="url" value="<? echo  esc_attr($comment_author_url); ?>" size="22" tabindex="3" />
        ...
        <p><textarea class="inpt inpttextarea" name="comment" id="comment" cols="58" rows="10" tabindex="4"></textarea></p>
        <p>
