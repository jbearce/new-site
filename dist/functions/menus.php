...
class new_site_menu_walker extends Walker_Nav_Menu {
    ...
    public function start_lvl(&$output, $depth = 0, $args = array()) {
        ...
        $toggle = in_array("accordion", $params) ? "<button class='menu-list_toggle'><i class='icon'><svg class='icon_svg ' aria-hidden='true'><use xlink:href='#angle-down' /></svg></i><span class='_visuallyhidden'>" . __("Toggle children", "daviess_county") . "</span></button>" : (in_array("hover", $params) || in_array("touch", $params) && !($this->is_mega && $depth > 0) ? "<button class='menu-list_toggle _visuallyhidden'>" . __("Toggle children", "daviess_county") . "</button>" : "");
