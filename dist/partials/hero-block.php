...
<div class="hero-block -fullbleed _nopadding" role="banner">
    <div class="hero_inner">
        <div class="hero_swiper-container swiper-container">
            ...
            <button class="swiper-button-prev"><i class='icon'><svg class='icon_svg ' aria-hidden='true'><use xlink:href='#caret-left' /></svg></i><span class="_visuallyhidden"><?php _e("Previous Slide", "new_site"); ?></span></button>
            <button class="swiper-button-next"><i class='icon'><svg class='icon_svg ' aria-hidden='true'><use xlink:href='#caret-right' /></svg></i><span class="_visuallyhidden"><?php _e("Next Slide", "new_site"); ?></span></button>
            <?php endif; ?>
