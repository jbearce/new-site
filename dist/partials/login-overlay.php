    ...
    <div class="login_inner">
        <form class="login_login-form login-form" action="<?php echo get_option("home"); ?>/wp-login.php" method="post">
            ...
            <div class="_textcenter">
                <button class="login-form_button button" type="submit"><i class='icon'><svg class='icon_svg ' aria-hidden='true'><use xlink:href='#arrow-right' /></svg></i> <?php _e("Sign in", "new_site"); ?></button>
            </div><!--/._textcenter-->
        ...
        <div class="login_login-form login-form -register">
            ...
            <div class="_textcenter">
                <a class="login-form_button button" href="<?php echo wp_registration_url(); ?>"><i class='icon'><svg class='icon_svg ' aria-hidden='true'><use xlink:href='#arrow-right' /></svg></i> <?php _e("Create your account", "new_site"); ?></a>
            </div><!--/._textcenter-->
